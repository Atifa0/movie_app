...
class _Search_ScreenState extends State<Search_Screen> {
  ...
  // Function to call the TMDb API for movie search
  ...
  // Function to fetch actors for each movie
  ...
  String _extractYear(String? releaseDate) {
    ...
    return releaseDate
        .split('-')[0]; // Assuming the date is in "YYYY-MM-DD" format
  }
      ...
      body: Container(
        ...
        child: Column(
          children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: Colors.white, width: 1), // Add white border
                      ),
                      child: Row(
                        children: [
            ...
            // Displaying search results or 'No movies found' message
            Expanded(
              child: _isLoading
                            ...
                            return Column(
                              children: [
                                ListTile(
                                  leading: Container(
                                    width: 140,
                                    // Adjust width for rectangular aspect ratio
                                    height: 89,
                                    // Adjust height for rectangular aspect ratio
                                    decoration: BoxDecoration(
                                    ...
                                    children: [
                                      ...
                                      FutureBuilder<List<String>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return Text(
                                            snapshot.data!.join(', '),
                                            // Join the actor names with commas
                                            style: TextStyle(
                                                color: Color(0xacffffff),
                                                fontSize: 13),
                                          );
                                      ...
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                            ...
                                            runtime: '',
                                            // Pass the runtime fetched dynamically
                                            actors:
                                                actors, // Pass the fetched actors
                                          ),
                                        ),
                                      );
                                    }
                                ...
                                if (index <
                                    _movies.length -
                                        1) // Add a divider except after the last item
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 25.0),
                                    // Add padding to shorten divider
                                    child: Divider(
                                      color: Color(0xff707070),
                                      thickness:
                                          1, // Optional: Adjust thickness if needed
                                    ),
                                  ),
                              ],
                            );
